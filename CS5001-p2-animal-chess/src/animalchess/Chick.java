...
/**
 * A Chick class extends from Promotable class.
...
public class Chick extends PromotablePiece {
    ...
    /**
     * constructor.
     * @param owner is the player who owns the chick piece
     * @param square is the situation where the chick piece is placed
     */
    ...
    /**
     * getter.
     * @return square[][] is the legalMoves list of chick
     */
    @Override
    public ArrayList<Square> getLegalMoves() {
        ...
        for (int i = row - 1; i <= row + 1; i++) {
            for (int j = col - 1; j <= col + 1; j++) {
                ...
                if ((!getIsPromoted()) && (i != row + forward || j != col)) {
                    continue;
                }
